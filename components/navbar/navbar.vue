<template>
	<view class="nav">
		...
		<view v-if="isHome" class="headNav" :style="'background-color:white;'+'height:' + navconheight + 'rpx;line-height:' + navconheight +'rpx;padding-left:20rpx;'">
		...
		<view v-else class="navbar" :style="'height:'+navconheight+'rpx;'+containerStyle">
			...
			<view class="nav-title" v-if="props.titleText">
				<view :style="`height:${navconheight}rpx;line-height:${navconheight}rpx;${textStyle}`">
					{{props.titleText}}
				</view>
			</view>
		</view>
